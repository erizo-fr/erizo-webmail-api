...
module.exports.postMessage = function* (next) {
	...
	this.checkBody("attachments").optional()
...
module.exports.getMessagePart = function* (next) {
	this.checkParams("box").notEmpty().match(sanitizerHelper.PATTERN_BOX)
	this.checkParams("id").notEmpty().match(sanitizerHelper.PATTERN_ID)
	this.checkParams("partId").notEmpty().match(sanitizerHelper.PATTERN_BODIES)
	if (!sanitizerHelper.hasError.call(this)) {
		yield next
	}
}

module.exports.getMessagePartContent = function* (next) {
	this.checkParams("box").notEmpty().match(sanitizerHelper.PATTERN_BOX)
	this.checkParams("id").notEmpty().match(sanitizerHelper.PATTERN_ID)
	this.checkParams("partId").notEmpty().match(sanitizerHelper.PATTERN_BODIES)
	if (!sanitizerHelper.hasError.call(this)) {
