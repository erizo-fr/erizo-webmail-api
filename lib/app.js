...
app.get('/account/userdata', authController.authRequired, accountSanitizer.getUserData, accountController.getUserData);
app.put('/account/userdata', authController.authRequired, accountSanitizer.updateUserData, accountController.updateUserData);
