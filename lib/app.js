...
app.get("/boxes/:box/messages/:id/parts/:partId", authController.authRequired, messageSanitizer.getMessagePart, messageController.getMessagePart)
app.get("/boxes/:box/messages/:id/parts/:partId/content", authController.authRequired, messageSanitizer.getMessagePartContent, messageController.getMessagePartContent)
app.patch("/boxes/:box/messages/:id", authController.authRequired, messageSanitizer.patchMessage, messageController.patchMessage)
