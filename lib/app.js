...
app.get('/account/data', authController.authRequired, accountController.getUserData);
app.put('/account/data', authController.authRequired, accountController.updateUserData);
